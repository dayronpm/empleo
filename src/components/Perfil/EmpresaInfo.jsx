...
const EmpresaInfo = () => {
    ...
    return (
        <div className="empresa-info p-4 border border-gray-300 rounded-lg mt-4 shadow-lg">
            ...
            <p className="text-gray-600 mb-2"><strong>Dirección:</strong> {empresa.provincia}, {empresa.municipio}</p>
            <p className="text-gray-800 mb-2"><strong>Tipo:</strong> {empresa.tipo}</p>
