...
const Sidebar = ({ setActivePage, isOpen, toggleSidebar }) => {
  return (
    <aside
      className={`bg-blue-600 text-white w-64 h-screen fixed top-0 left-0 overflow-y-auto transform transition-transform duration-300 z-50 ${
        isOpen ? 'translate-x-0' : '-translate-x-full'
      }`}
    >
      {/* Encabezado del Menú */}
      <div className="p-4 bg-blue-700 text-center text-lg font-bold">
        Menú
      </div>
      {/* Lista de Enlaces */}
      <nav className="mt-4">
